...
function mtech_showcase_default_markers() {
	return array(
		array( 'id' => 'radio',    'title' => 'Two-Way Radios',          'description' => 'Own your communication. Stay in control.',                                                     'icon' => '📡', 'link' => 'https://www.brentwoodradios.co.uk/what-we-do/two-way-radios-for-sale/', 'x' => 67.6, 'y' => 38.0 ),
		array( 'id' => 'poc',      'title' => 'PoC Radios',               'description' => 'All-in-one device. Smart communications. Lower costs.',                                          'icon' => '📱', 'link' => 'https://www.brentwoodradios.co.uk/idaro-devices/',                       'x' => 60.2, 'y' => 27.8 ),
		array( 'id' => 'cctv',     'title' => 'CCTV & Access Control',    'description' => 'See clearly. Stay in control. Protect what matters.',                                            'icon' => '🎥', 'link' => 'https://www.brentwoodradios.co.uk/cctv-access-control/',                 'x' => 74.2, 'y' => 18.6 ),
		array( 'id' => 'bodycam',  'title' => 'Body Worn Cameras',        'description' => 'See everything, miss nothing.',                                                                  'icon' => '🎦', 'link' => 'https://www.brentwoodradios.co.uk/bodycams/',                            'x' => 61.0, 'y' => 44.7 ),
		array( 'id' => 'sensors',  'title' => 'Smart Sensors',            'description' => 'Smart monitoring for safer environments.',                                                        'icon' => '📶', 'link' => '/smart-sensors/',                                                         'x' => 85.7, 'y' => 16.7 ),
		array( 'id' => 'av',       'title' => 'Audio Visual',             'description' => 'Radio and audio-visual solutions for events and venues worldwide.',                                'icon' => '🔊', 'link' => 'https://www.brentwoodradios.co.uk/audio-visual/',                        'x' => 55.3, 'y' => 49.2 ),
		array( 'id' => 'ai',       'title' => 'MTech AI',                 'description' => 'Every voice becomes action. Transform your radio network into a 24/7 virtual dispatcher.',        'icon' => '🤖', 'link' => '/mtech-ai/',                                                              'x' => 80.8, 'y' => 38.8 ),
		array( 'id' => 'drones',   'title' => 'Drones',                   'description' => 'Smarter. Safer. Faster. Capture aerial data and improve site safety.',                             'icon' => '🚁', 'link' => '/drones/',                                                                'x' => 61.6, 'y' => 64.8 ),
		array( 'id' => 'vape',     'title' => 'Vape Detectors',           'description' => 'Detect vaping and vandalism in real time. Protect students and staff, deter misuse instantly.',    'icon' => '🚭', 'link' => 'https://www.brentwoodradios.co.uk/vape-detectors/',                      'x' => 37.5, 'y' => 20.7 ),
	);
}
