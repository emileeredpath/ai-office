...
const seedTasks: TaskRecord[] = [
  ...
  task({ id: 'task-23', title: 'Q3 Education Campaign — MTech Group Email', brand: 'mtech', deadline: '2026-08-31', createdAt: '2026-07-27' }),
  task({ id: 'task-24', title: 'Q3 Education Campaign — Social Posts', brand: 'mtech', deadline: '2026-08-31', createdAt: '2026-07-27' }),
  task({ id: 'task-25', title: 'Q3 Education Campaign — Update landing page', brand: 'mtech', deadline: '2026-08-31', createdAt: '2026-07-27' }),
  task({ id: 'task-26', title: 'Q3 Education Campaign — Landing page PPC review', brand: 'mtech', deadline: '2026-08-31', createdAt: '2026-07-27' }),
