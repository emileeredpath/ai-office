      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <KpiCard title="Unique Clicks" value={headline.status === 'available' ? headline.clicks?.toLocaleString('en-GB') : undefined} status={headline.status} subtitle="Campaign Monitor's Clicks field — unique clicking subscribers" accent="var(--v2-green)" />
            <KpiCard title="Unique Click Rate" value={headline.status === 'available' && headline.clickRate != null ? `${headline.clickRate}%` : undefined} status={headline.status === 'available' && headline.clickRate != null ? 'available' : 'not-connected'} subtitle={headline.subtitle} accent="var(--v2-green)" />
            <KpiCard title="Click-to-Open Rate" value={headline.status === 'available' && headline.clickToOpenRate != null ? `${headline.clickToOpenRate}%` : undefined} status={headline.status === 'available' && headline.clickToOpenRate != null ? 'available' : 'not-connected'} subtitle="Unique clicks ÷ unique opens" />
